...
function App() {
  ...
  return (
    <div style={{ padding: "20px", fontFamily: "Arial, sans-serif", background: "#f5f7fb", minHeight: "100vh" }}>
      <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
        <h1 style={{ marginBottom: "5px" }}>Macky Nexus Services</h1>
        <p style={{ marginTop: 0, color: "#555" }}>
          Connecting Vendors, Jobs & Customers
        </p>
                        ...
                        <td>
                          ...
                          {lead.vendorPhone && (
                            <>
                              ...
                              {" | "}
                              <a
                                href={`https://wa.me/91${lead.vendorPhone}`}
                                target="_blank"
                                rel="noreferrer"
                              >
                                WhatsApp
